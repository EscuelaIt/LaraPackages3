...
<div class="container">
    <div class="row">
        <div class="button-right">
            <a href="<?php echo e(url('admin/recipes/create')); ?>" class="btn btn-primary" role="button">Añadir receta</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">                    
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(url('admin/recipes/'.Hashids::encode($recipe->id).'/edit')); ?>">Editar</a> | <a href="<?php echo e(url('admin/recipes/destroy/'.Hashids::encode($recipe->id).'')); ?>">Borrar</a></td>
                            </tr>
