...
class RecipeController extends Controller
{
    ...
    {
        $this->saveData();
        return redirect(Functions::parseLang()."/admin/recipes")->with('status', 'Registro guardado correctamente');
    }
    ...
    public function update($id)
    {
        ...
        return redirect(Functions::parseLang()."/admin/recipes/" . $id . "/edit")->with('status', 'Registro guardado correctamente');
    }
    ...
    public function destroy($id)
    {
        ...
        $recipes->delete();
        return redirect(Functions::parseLang()."/admin/recipes")->with('status', 'Registro borrado correctamente');
    }
    ...
    public function saveData($id = null)
    {
        ...
        $recipes->title    = Request::get('title');
        $recipes->description = Request::get('description');
        $recipes->locale = Functions::parseLang();
